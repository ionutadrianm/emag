...
class HomePage(BasePage):
    ...
    CONTUL_MEU_SPAN = (By.XPATH, '(//span[contains(text(),"Contul meu")])[2]')
    ...
    def click_contul_meu_btn(self):
        self.hover_by_selector(*self.CONTUL_MEU_SPAN)
        self.driver.find_element(*self.INTRA_IN_CONT_BTN).click()
